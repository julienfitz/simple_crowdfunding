...
class DonationsControllerTest < ActionController::TestCase
  ...
  test "should create donation" do
    assert_difference('Donation.count') do
      post :create, donation: { email: @donation.email, level: @donation.level, level_descrip: @donation.level_descrip, name: @donation.name, price: @donation.price }
    end
  ...
  test "should update donation" do
    patch :update, id: @donation, donation: { email: @donation.email, level: @donation.level, level_descrip: @donation.level_descrip, name: @donation.name, price: @donation.price }
    assert_redirected_to donation_path(assigns(:donation))
  end
